		...
		list: [
			{classfly: '直播', href: 'live', ico: 'ico-aperture', link: [
				...
				{connect: '网络直播', href: 'live-web',web: [
					...
					{site: '哔哩哔哩', href: 'live.bilibili.com', pay: 'ture', vpn: '', adult: '', info: '哔哩哔哩综合直播'},
				],},
			],},
			{classfly: '影视', href: 'movie', ico: 'ico-movie', link: [
				{connect: '在线影视', href: 'movie-online',web: [
					...
					{site: 'LIBVIO', href: 'libvio.cc', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					{site: '爱迪影视', href: 'adys.tv', pay: '', vpn: '', adult: '', info: '最新韩剧电视剧'},
					{site: '大米星球', href: 'dmdcv.shop', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					...
					{site: '555电影', href: '5557197.vip', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					{site: '仙女影视', href: 'xnys.cc', pay: '', vpn: '', adult: '', info: '为集美、小仙女定制的影视大全'},
					{site: '网飞TV', href: 'wangfei.tv', pay: '', vpn: '', adult: '', info: '网飞影视剧集'},
					{site: 'Gimy TV 剧迷', href: 'gimy.tv', pay: '', vpn: '', adult: '', info: '免费高清追剧'},
					{site: '枫林网', href: 'imaple8.co', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					{site: '94i影城', href: '94itv.app', pay: '', vpn: '', adult: '', info: '免费电影线上看'},
					{site: '网飞猫', href: 'ncat21.com', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					{site: '奈飞工厂', href: 'netflixgc.com', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					{site: '91毒舌电影', href: 'duse1.com', pay: '', vpn: '', adult: '', info: '免费电影线上看'},
					{site: '奈菲影视', href: 'nfyingshi.com', pay: '', vpn: '', adult: '', info: '如果生活很无趣但至少我可以陪你看剧'},
					{site: '注视影视', href: 'gaze.run', pay: '', vpn: '', adult: '', info: '免费电影线上看'},
					{site: '久久影视', href: 'putaojuchang.com', pay: '', vpn: '', adult: '', info: '最新电影电视剧在线观看'},
				],},
				{connect: '短剧', href: 'movie-short',web: [
					{site: 'DIANLE', href: 'duanju55.com', pay: '', vpn: '', adult: '', info: '免费五五短剧'},
					{site: '短剧库', href: 'so.duanjuku.top', pay: '', vpn: '', adult: '', info: '短剧搜索'},
					{site: '红果短剧', href: 'novelquickapp.com', pay: '', vpn: '', adult: '', info: '热门短剧'},
					{site: '短剧狗', href: 'duanjugou.top', pay: '', vpn: '', adult: '', info: '全网免费短剧合集'},
					{site: '短剧号', href: 'duanjuhao.top', pay: '', vpn: '', adult: '', info: '一个免费的短剧网盘'},
			...
			{classfly: '动漫', href: 'comic', ico: 'ico-naruto', link: [
				{connect: '动画', href: 'comic-animation',web: [
					...
					{site: '漫漫搜', href: 'msousou.vip', pay: '', vpn: '', adult: '', info: '让搜番变得更简单'},
					{site: '樱花动漫', href: 'yinghuadongman.me', pay: '', vpn: '', adult: '', info: '专注二次元ACG动漫'},
				],},
				{connect: '漫画', href: 'comic-cartoon',web: [
					...
					{site: '拷贝漫画', href: 'mangacopy.com', pay: '', vpn: '', adult: '', info: '动画新番'},
				],},
			],},
			...
			{classfly: '音乐', href: 'music', ico: 'ico-music', link: [
				...
				{connect: '音乐资源', href: 'music-down',web: [
					{site: 'HiFiNi', href: 'hifiti.com', pay: '', vpn: '', adult: '', info: '无损音乐下载'},
					{site: '我爱无损音乐网', href: '52wusun.com', pay: '', vpn: '', adult: '', info: '无损音乐下载'},
					{site: '开开无损音乐', href: 'kkws.cc', pay: '', vpn: '', adult: '', info: '无损音乐下载'},
					{site: '无损音乐', href: 'isflac.com', pay: '', vpn: '', adult: '', info: '无损音乐下载'},
					{site: '极光无损', href: 'jgwav.com', pay: '', vpn: '', adult: '', info: '无损音乐下载'},
					{site: '5 SONG', href: '5song.xyz', pay: '', vpn: '', adult: '', info: '无损音乐下载'},
				],},
			],},
			...
			{classfly: '素材', href: 'material', ico: 'ico-knowledge', link: [
				{connect: '图片素材', href: 'material-image',web: [
					...
					{site: 'Free Premium Mockups', href: 'mockups-design.com', pay: '', vpn: 'ture', adult: '', info: '样品展示素材库'},
					...
					{site: 'Negativespace', href: 'negativespace.co', pay: '', vpn: 'ture', adult: '', info: 'Beautiful free images'},
				],},
			...
			{classfly: '开发', href: 'develop', ico: 'ico-alone-verification', link: [
				{connect: '前端', href: 'develop-frontend',web: [
					...
					{site: 'Svelte', href: 'svelte.dev', pay: '', vpn: 'ture', adult: '', info: '构建Web应用程序的一种新方法'},
					...
					{site: '渐变编辑器', href: 'colorzilla.com/gradient-editor', pay: '', vpn: 'ture', adult: '', info: '用于创建渐变的编辑器'},
			...
			{classfly: '工具', href: 'tool', ico: 'ico-spanner', link: [
				{connect: '协作效率', href: 'tool-efficiency',web: [
					...
					{site: 'MasterGo在线设计', href: 'mastergo.com', pay: 'ture', vpn: '', adult: '', info: '在线设计器'},
					...
					{site: 'Pixelart', href: 'pixelart.liveblocks.app', pay: '', vpn: 'ture', adult: '', info: '像素画多人协作绘画'},
				...
				{connect: '小工具', href: 'tool-min',web: [
					...
					{site: '字体格式转换', href: 'everythingfonts.com/font-face', pay: '', vpn: 'ture', adult: '', info: '讲电脑文字转换成WEB文字'},
