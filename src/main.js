		...
		list: [
			...
			{classfly: '影视', href: 'movie', ico: 'ico-movie', link: [
				{connect: '在线影视', href: 'movie-online',web: [
					...
					{site: '小鸭看看', href: 'xiaoyakankan.com', pay: '', vpn: '', adult: '', info: '每天搜集互联网最新电影和电视剧'},
					{site: '网飞TV', href: 'wangfei.in', pay: '', vpn: '', adult: '', info: '奈飞影视剧集弹幕网'},
					{site: '哔嘀影视', href: 'bdys10.com', pay: '', vpn: '', adult: '', info: '热门电影'},
					...
					{site: '爱欧乐影院', href: 'iole.tv', pay: '', vpn: '', adult: '', info: '海外在线视频媒体平台'},
					{site: '大师兄影视', href: 'dsxys.pro', pay: '', vpn: '', adult: '', info: '永久免费的福利超清影视站'},
					{site: '厂长资源', href: 'czzy88.com', pay: '', vpn: '', adult: '', info: '超清视频站'},
					{site: 'Gimy小鴨影音', href: 'gimy.cc', pay: '', vpn: '', adult: '', info: '免费电影线上看'},
					{site: 'Gimy剧迷', href: 'gimy.im', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					{site: '枫林网', href: 'imaple8.co', pay: '', vpn: '', adult: '', info: '超清视频站'},
					...
					{site: '6V电影', href: '66s6.net', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					...
					{site: '人人影视', href: 'renren.pro', pay: '', vpn: '', adult: '', info: '聚合全网高清影视在线观看'},
					{site: '爱壹帆', href: 'iyf1.tv', pay: '', vpn: '', adult: '', info: '电影电视剧'},
					{site: '真不卡影院', href: 'bkyb.net', pay: '', vpn: '', adult: '', info: '最新电视剧'},
					{site: '全集网', href: 'yijia5.com', pay: '', vpn: '', adult: '', info: '免费电影线上看'},
					{site: '榜一短剧', href: 'duanju.one', pay: '', vpn: '', adult: '', info: '短剧在线看'},
				],},
			...
			{classfly: '音乐', href: 'music', ico: 'ico-music', link: [
				...
				{connect: '音乐资源', href: 'music-down',web: [
					...
					{site: '万籁音乐', href: 'onelai.cn', pay: '', vpn: '', adult: '', info: '音乐打包下载'},
					{site: '熊猫无损音乐', href: 'xmwav.com', pay: '', vpn: '', adult: '', info: '无损音乐免费下载'},
			...
			{classfly: '素材', href: 'material', ico: 'ico-knowledge', link: [
				...
				{connect: '视频素材', href: 'material-video',web: [
					...
					{site: 'Vidsplay', href: 'vidsplay.com', pay: '', vpn: 'ture', adult: '', info: '高质量摄影视频素材全都免费商用'},
				],},
				{connect: '其他素材', href: 'material-other',web: [
					...
					{site: 'MingCute Icon', href: 'mingcute.com', pay: '', vpn: '', adult: '', info: 'Carefully Designed Icon Library'},
			...
			{classfly: '开发', href: 'develop', ico: 'ico-alone-verification', link: [
				...
				{connect: '游戏', href: 'develop-game',web: [
					...
					{site: 'Deep-Fold', href: 'deep-fold.itch.io', pay: '', vpn: '', adult: '', info: '像素风游戏开发'},
				],},
			],},
			{classfly: '工具', href: 'tool', ico: 'ico-spanner', link: [
				...
				{connect: '音视频处理', href: 'tool-media',web: [
					...
					{site: '度加创作工具', href: 'aigc.baidu.com', pay: '', vpn: '', adult: '', info: '一站式聚合百度AIGC能力'},
				],},
